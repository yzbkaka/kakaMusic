...
public class ScanView extends View {
     ...
     * 第一圈圆环颜色
     */
    private String circlrColor1;

    /**
     * 第二圈圆环颜色
     */
    private String circlrColor2;

    /**
     * 第三圈圆环颜色
     */
    private String circlrColor3;
    ...
    public ScanView(Context context, AttributeSet attrs) {
        ...
        color = colorToHexString(Color.red(accentColor)) + colorToHexString(Color.green(accentColor)) + colorToHexString(Color.blue(accentColor));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        viewSize = 500;
        setMeasuredDimension(viewSize, viewSize);  //设置固定值为500
    }
