...
public class SelectorUtil {
    ...
    public static void changeViewColor(StateListDrawable drawable, int[] rgbColors) {
        ...
        try {
            Method method = constantState.getClass().getMethod("getChildren", new Class[0]);// 通过反射调用getChildren方法获取xml文件中写的drawable数组
            method.setAccessible(true);
            Object obj = method.invoke(constantState, new Object[]{});
